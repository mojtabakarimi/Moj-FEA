...
{
    public class ModelFrame2D: Model
    {
        public ModelFrame2D() 
            : base(2,3)
        {
            ...
            //this.ProfileSections = new List<BaseProfileSection>();
        }
        ...
        {
            {
                ...
                this.Nodes.Add(new Node2D(name, new []{x, y}, 3));
        ...
        public int AddProfileSection(string name, double area, double Ix)
        {
            ...
            this.ProfileSections.Add(new SectionProfileFrame2D(name, area, Ix));
        ...
        public int AddElement(string name, string node1, string node2, string materialName, string sectionName)
        {
            ...
            var profileSection = ProfileSections.SingleOrDefault(p => p.Name == sectionName) as SectionProfileFrame2D;
            if (profileSection == null)
            {
                throw new ArgumentException($"Unknown profile section name {profileSection}");
            }

            this.LineElements.Add(new Frame2D(name, i, j, profileSection.A, material.ModulusOfElasticity, profileSection.Ix));
            return this.LineElements.Count - 1;
        }

        public void AddRestraint(string name, bool dx, bool dy, bool rz)
        {
        ...
        public void AddNodalForce(string name, string loadCase, double fx, double fy, double mx)
        {
            ...
            NodalForces.Add(new NodalForce(nodeIndex, loadCaseIndex, new[] {fx, fy, mx}));
